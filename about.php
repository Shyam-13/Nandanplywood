        ...
        <div class="container py-md-5 py-4">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 ps-xl-5 mt-lg-0 mt-5">
                    <h3 class="title-style mb-lg-4 mb-3">Who we are & What we do?</h3>
                    <p><span style="font-weight: bolder;">Who We Are:</span>
                    We are a passionate team of retail enthusiasts dedicated to providing exceptional shopping experiences. With a strong commitment to customer satisfaction, we strive to be a trusted destination for all your shopping needs.</p></b>

                    <p><span style="font-weight: bolder;">What We Do:</span>
                    At our shop, we curate a wide selection of high-quality products across various categories. From fashion and accessories to home decor and electronics, we offer carefully chosen items that blend style, functionality, and value.</p></b>
                </b>
                    <p>Our goal is to make your shopping journey enjoyable, convenient, and rewarding. Whether you're searching for a special gift or upgrading your own collection, we are here to help you find exactly what you need with ease and satisfaction.The shop was established in 2000 by <strong>Mr. Pnakaj Bhut</strong>
                    </p></b>
                </div>
            </div>  
        </div>
        ...
        <div class="team py-5">
            <div class="container py-md-5 py-4">
                <div class="title-heading-w3 text-center mx-auto mb-md-5 mb-4" style="max-width:500px;">
                    <h3 class="title-style" style="color:#fff;">Meet our brand</h3>
                </div>
                ...
                <div class="col-lg-3 col-6 team-wrap">
                    ...
                    <div class="col-lg-3 col-6 team-wrap">
                        <div class="team-member text-center">
                            <div class="team-img">
                                <img src="assets/images/GS-Final-PNG.jpg" alt="" class="radius-image" >
                            </div>
                            <a href="#url" class="team-title">GOLDSTONE</a>
                    ...
                    <div class="col-lg-3 col-6 team-wrap">
                        <div class="team-member text-center">
                            <div class="team-img">
                                <img src="assets/images/SRG.jpg" alt="" class="radius-image">
                            </div>
                            <a href="#url" class="team-title">SRG</a>
                            <div class="team-details text-center">
                                <div class="socials mt-20">
                                    <a href="#facebook">
                                        <span class="fab fa-facebook-f"></span>
